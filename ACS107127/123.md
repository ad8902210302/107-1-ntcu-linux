...
###  這個帳號可能的家目錄所保留的 UID 與 GID， 並嘗試以該帳號原有的UID/GID資訊來重建該</br>
###　帳號。而這個帳號的密碼請給予 ItIsExam 的樣式。</br></br>
...
###　調整成 2012 年 12 月 21 日 (日期正確即可，時間隨便)</br></br>
...
#####  建立檔案用"touch"、建立目錄用"mkdir"。複製用"cp"，更改權限用"chmod"。
...
![Alt text](https://github.com/ad8902210302/107-1-ntcu-linux/blob/master/ACS107127/123/13.jpg)</br>
