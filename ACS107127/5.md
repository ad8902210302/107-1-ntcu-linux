...
###  *  建立實體連結，原始檔案為 /etc/hosts 而新的檔案檔名為 /srv/hosts.hard，請找出/srv/hosts.hard的 inode 號碼為幾號？</br>
####     Ans:4430496</br>
...
###  *  建立符號連結，原始檔案為 /etc/hosts 而新的檔案檔名為 /srv/hosts.soft，請找出/srv/hosts.soft的 inode 號碼為幾號？</br>
####     Ans:187</br>

###     1.這個 inode 共有幾個檔名在使用?</br>
####    Ans:1個</br>
###     2.說明原因:</br>
####    Ans:符號連結就是在建立一個獨立的檔案，而這個檔案會讓資料的讀取指向他link的那個檔案的檔名，所以會有一個不同的inode，當然也只會有"1"個連接數。</br>
