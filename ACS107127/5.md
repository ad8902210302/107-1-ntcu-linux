...
###  <ul>建立實體連結，原始檔案為 /etc/hosts 而新的檔案檔名為 /srv/hosts.hard，請找出/srv/hosts.hard的 inode 號碼為幾號？  </br>
####     Ans:4430496</br>
...
###  <ul>建立符號連結，原始檔案為 /etc/hosts 而新的檔案檔名為 /srv/hosts.soft，請找出/srv/hosts.soft的 inode 號碼為幾號？  </br>
####     Ans:187</br>
